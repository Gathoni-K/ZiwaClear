...
export default function About() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* The Problem */}
      <section className="px-4 md:px-8 py-16 md:py-20 bg-tile/20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl md:text-2xl font-bold mb-6">The Problem We Solve</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 text-sm">
            <div className="bg-tile border border-border-ui rounded-xl p-5 md:p-6">
              <p className="font-bold text-primary text-xl md:text-2xl mb-2">$80M</p>
            ...
            <div className="bg-tile border border-border-ui rounded-xl p-5 md:p-6">
              <p className="font-bold text-primary text-xl md:text-2xl mb-2">55%</p>
              <p className="text-muted text-xs md:text-sm">
            ...
            <div className="bg-tile border border-border-ui rounded-xl p-5 md:p-6">
              <p className="font-bold text-primary text-xl md:text-2xl mb-2">100 mg</p>
              <p className="text-muted text-xs md:text-sm">
      ...
      <section className="px-4 md:px-8 py-16 md:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted mb-8 md:mb-10 leading-relaxed text-sm md:text-base">
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            {[
              ...
              <div
                key={step}
                className="flex gap-3 md:gap-5 bg-tile border border-border-ui rounded-xl p-4 md:p-6"
              >
                <span className="text-2xl md:text-3xl font-bold text-primary shrink-0">
                  {step}
                </span>
                <div>
                  <p className="font-bold text-sm md:text-lg">{title}</p>
                  <p className="text-xs md:text-sm text-muted mt-1">{desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Impact */}
      <section className="px-4 md:px-8 py-16 md:py-20 bg-tile/20 border-t border-border-ui">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-xl md:text-2xl font-bold mb-8 md:mb-10">Measurable Impact</h2>
          ...
          <p className="text-[10px] md:text-xs text-muted mt-6">
      ...
      {/* CTA */}
      <section className="px-4 md:px-8 py-16 md:py-20 border-t border-border-ui text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-muted mb-6 text-xs md:text-sm leading-relaxed">
          ...
          <Link
            to="/#partner"
            className="inline-flex items-center gap-2 px-5 md:px-6 py-3 bg-primary text-background font-semibold rounded-pill text-sm hover:bg-primary-hover transition-colors"
          >
