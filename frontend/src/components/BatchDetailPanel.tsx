...
export function BatchDetailPanel({
  ...
  return (
    <div className="absolute top-2 right-2 md:top-4 md:right-4 w-[calc(100%-16px)] max-w-[300px] rounded-tile bg-tile border border-border-ui shadow-lg p-4 md:p-5 z-[1000]">
